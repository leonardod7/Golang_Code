...
func iniciarMonitoramento() {
	...
	// Trabalhando com arrays e slices. O array possui um tamanho fixo. O slice possui uma estrutura variável, normalmente utilizada.

	fmt.Println("Monitoramento...")
	var sites [4]string
	sites[0] = "http://www.d7par.com.br"
